...
**NOTE 1: as of 2023-07-06, these instructions are considered APPROVED. MDE teams have worked through several iterations to ensure the methods described here meet our essential requirements. We apologize that these scenarios were not identified earlier in the ambiguity resolution.**

**NOTE 2: For school year 2024-25, these instructions have been superseded.** See [the updated document](/2024-25%20MDE%20Ed-Fi%20Documentation/ssa_construction_for_multiple_ee.md) in the 2024-25 folder for instructions pertaining to that year.
