# Early Education Disambiguation Resolution and Workaround

## IMPORTANT: Resolution Implemented in 2023-24
For **school year 2023-24**, MDE implemented an "Early Education ambiguity resolution" that will allow districts to enroll students in both a "non-MARSS Early Education program" and a "MARSS Early Education program" at the same school, during the same time period. More information on that resolution is available [in this PDF](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/2023-24%20MDE%20Ed-Fi%20Documentation/early_ed_marss_conflict_resolution.pdf). It is also integrated into the [Early Education vendor certification scenarios](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/sandbox_cert/sandbox_cert_d_earlyed.md), with minor changes to the [Student Program Associations](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/sandbox_cert/sandbox_cert_c_spas.md) and [MARSS](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/sandbox_cert/sandbox_cert_b_marss.md) scenarios. Sample JSON files for calendars and program associations are available in the [EE-MARSS Ambiguity Resolution](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/data/EE-MARSS%20Ambiguity%20Resolution/) folder of the data directory.

## Workaround Details for 2022-23 and earlier
The remainder of this document describes the *workaround* for **school years 2021-22 and 2022-23** when building and submitting records for these students. We are including tabular descriptions designed for a district audience, and links to JSON examples designed for vendors.

This scenario detailed here describes a student enrolled in an ECSE school (such as [Bloomington ECSE 0271-01-502](https://pub.education.mn.gov/MdeOrgView/organization/show/1800)) that is also attending ECFE **and** School Readiness programs. This is just one of several scenarios that may need to use this workaround due to the inability to submit multiple SSAs for the same student, same school, and same begin date. When this problem arises and the workaround is required, the key thing to remember is to use the **actual enrollment date** for the SSA record used for MARSS Early Education programs (which use grade levels EC for ECSE, RA-RJ for SR+, PA-PJ for VPK, and PS for PS.)
