...
|Student ID |**1997358**|   "studentReference": "studentUniqueId"|Use MARRS number |
...
|Student ID |**1997358**|   "studentReference": "studentUniqueId"|Same as SSA record 1 |
...
| Data Element | Data to Enter |Ed-Fi element| Notes / Description |
| ---- |:-----:|-----| ---|
|School ID | **10271502**| "programReference": "educationOrganizationId" | |
|Student ID |**1997358**|   "studentReference": "studentUniqueId"|Use MARRS number |
...
| Data Element | Data to Enter |Ed-Fi element| Notes / Description |
| ---- |:-----:|-----| ---|
|School ID | **10271502**|  "programReference": "educationOrganizationId" |Same as SSA record 1 |
|Student ID |**1997358**|   "studentReference": "studentUniqueId"|Same as SSA record 1 |
...
Note that this workaround can *also* be used when needing to associate a student with *both* ECFE and SR program associations, as needed.