...
>For **school year 2023-24**, MDE will be implementing an "Early Education disambiguation project" that will allow districts to enroll students in both a "non-MARSS Early Education program" and a "MARSS Early Education program" at the same school, during the same time period. More information on that resolution will be documented in spring 2023, and integrated into at least the [Early Education vendor certification scenarios](sandbox_cert_d_earlyed.md).
