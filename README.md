...
## SCHEDULE NOTES
- This documentation now reflects the MDE Ed-Fi implementation for **School Year 2024-25**. Note that very little is changing from the 2023-24 school year, outside of some additional certification testing such as the [Deleting Resources Certification Scenarios](sandbox_cert_h_deleting_resources.md) and [Joint Powers Certification Scenarios](/sandbox_cert_j_joint_powers.md). Overview documentation is available in [this folder](./2024-25%20MDE%20Ed-Fi%20Documentation/), including [this Joint Powers diagram](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/2024-25%20MDE%20Ed-Fi%20Documentation/Joint%20Powers%20District%20Scenarios%20Diagram.pdf).
