...
As described above, each student must first have a StudentSchoolAssociation record (an enrollment record). Starting in SY2023-24, all EE enrollments used grade 'EE' due to the resolution described in the [EE-MARSS conflict resolution document](https://mn-mde-edfi.github.io/MDE-EdFi-Documentation/images/early_ed_marss_conflict_resolution.pdf).
